...
data/ontology/ontology.edn EAVT schema + verdicts + instruments + degradation-models + NEGATIVE SPACE
data/seed/seed.edn          6 regions × 4 lifelines = 24 cells + 11 deployed assets (5 lifelines incl. road)
